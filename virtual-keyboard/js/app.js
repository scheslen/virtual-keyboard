...
window.onload = function () {
  ...
  let keyMode = 2;
  if ('keyMode' in localStorage) keyMode = localStorage.getItem('keyMode');
  else localStorage.setItem('keyMode', keyMode);
  ...
  function endPress() {
    for (let i = 0; i < apKey.length; i += 1) {
  ...
  function toggleCapsLock() {
    ...
    else if (keyMode === 3) keyMode = 2;
    else if (keyMode === 4) keyMode = 5;
    else keyMode = 4;
  ...
  function toggleLanguage() {
    ...
    else if (keyMode === 3) keyMode = 5;
    else if (keyMode === 4) keyMode = 2;
    else keyMode = 3;
  ...
  apKey = document.querySelectorAll('.key');
